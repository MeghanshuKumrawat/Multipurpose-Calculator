...
class Age():
    def __init__(self, root):
        ...
        # date entry
        Label(self.root, text="Date of birth", bg='black', fg='white', font=('times_new_roman 15 bold')).place(x=10, y=10)
        Label(self.root, text="Date", bg='black', fg='white', font=('times_new_roman 15 bold')).place(x=10, y=60)
        self.birth_date = DateEntry(self.root, background='black')
        self.birth_date.place(x=200, y=15)
        self.current_date = DateEntry(self.root, background='black')
